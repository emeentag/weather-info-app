package com.care.app.unit.services;
...
public class WeatherServiceTest {
  ...
  @Test
  public void testWeatherService() throws JsonParseException, JsonMappingException, IOException {
    ...
    Assert.assertEquals(Integer.valueOf(800), this.weatherService.getWeather("Istanbul").getCode());
